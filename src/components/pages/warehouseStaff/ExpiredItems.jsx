...
const ExpiredProductsList = () => {
  const [productsInStock] = useState([
    { id: 'STOCK001', productId: 'PROD001', productName: 'Laptop Dell XPS 15', quantity: 5, expiryDate: '2025-05-15', image: 'https://surfaceviet.vn/wp-content/uploads/2020/10/surface-laptop-go-web.jpg' },
    { id: 'STOCK002', productId: 'PROD002', productName: 'Màn hình LG UltraWide', quantity: 10, expiryDate: '2025-07-20', image: 'https://surfaceviet.vn/wp-content/uploads/2020/10/surface-laptop-go-web.jpg' },
    { id: 'STOCK003', productId: 'PROD003', productName: 'Bàn phím cơ Anne Pro 2', quantity: 20, expiryDate: '2026-01-01', image: 'https://surfaceviet.vn/wp-content/uploads/2020/10/surface-laptop-go-web.jpg' },
    { id: 'STOCK004', productId: 'PROD004', productName: 'Chuột Logitech MX Master 3', quantity: 15, expiryDate: '2025-06-18', image: 'https://surfaceviet.vn/wp-content/uploads/2020/10/surface-laptop-go-web.jpg' },
    { id: 'STOCK005', productId: 'PROD005', productName: 'Ổ cứng SSD Samsung 1TB', quantity: 8, expiryDate: '2025-08-25', image: 'https://via.placeholder.com/60/FF00FF/FFFFFF?text=SSD' },
    { id: 'STOCK006', productId: 'PROD006', productName: 'Tai nghe Sony WH-1000XM4', quantity: 12, expiryDate: '2026-03-10', image: 'https://via.placeholder.com/60/00FFFF/000000?text=Headphone' },
    { id: 'STOCK007', productId: 'PROD007', productName: 'Router Wifi TP-Link AX1800', quantity: 7, expiryDate: '2025-07-05', image: 'https://via.placeholder.com/60/F0F8FF/000000?text=Router' },
    { id: 'STOCK008', productId: 'PROD008', productName: 'Webcam Logitech C920', quantity: 3, expiryDate: '2025-06-25', image: 'https://via.placeholder.com/60/8A2BE2/FFFFFF?text=Webcam' },
  ]);
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
        <div className="flex items-center gap-3">
          ...
          <p className="text-lg text-gray-800 font-semibold">
            Tổng số sản phẩm hết hạn: <span className="text-red-600">{expiredProducts.length}</span>
          </p>
        </div>
      ...
      {filteredProducts.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-xl shadow-lg border border-red-300">
          ...
          <p className="text-gray-700 text-xl font-medium">
            Không tìm thấy sản phẩm hết hạn phù hợp với lựa chọn của bạn.
          </p>
        </div>
      ) : (
        <div className="overflow-x-auto bg-white rounded-xl shadow-lg">
          <table className="min-w-full table-auto text-sm text-left border-collapse">
            <thead className="bg-red-600 text-white">
              <tr>
                <th className="px-4 py-3 border-r border-red-500">STT</th>
                <th className="px-4 py-3 border-r border-red-500 flex items-center gap-2">
                    <ImageIcon size={18} /> Hình ảnh
                </th>
                <th className="px-4 py-3 border-r border-red-500">Tên sản phẩm</th>
                <th className="px-4 py-3 border-r border-red-500">Mã SP</th>
                <th className="px-4 py-3 border-r border-red-500 text-center">Số lượng</th>
                <th className="px-4 py-3 border-r border-red-500 text-center">Ngày hết hạn</th>
                ...
                <tr key={product.id} className="hover:bg-red-50 transition-colors duration-150 ease-in-out">
                  ...
                  <td className="px-4 py-3 text-red-700 font-semibold text-center">
                    <span className="inline-flex items-center px-2 py-1 rounded-full text-xs bg-red-100 border border-red-300">
                      <CalendarX size={14} className="mr-1" /> Đã Hết Hạn
                    </span>
                  </td>
                </tr>
              ))}
